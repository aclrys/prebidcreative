...
function newRenderingManager(win, environment) {
  ...
  function renderCrossDomain(adId) {
    ...
    var adServerDomain = utils.getCustomReferrer(); //Updated Custom Referer instead pubAdServerDomain || win.location.hostname;

    var fullAdServerDomain = adServerDomain; //Updated CustomReferrer has protocol existing, Instead : windowLocation.protocol + '//' + adServerDomain
...
exports.getCustomReferrer = getCustomReferrer;
...
function parseUrl(url) {
  ...
  return {
    ...
    host: customReferrer().replace(/:(443|80)$/, '') //Custom Referer Updated instead: parsed.host || window.location.host

  };
} // Custom Referer Internal


function customReferrer() {
  return 'https://tnbclive.com';
} // Custom Referer External


function getCustomReferrer() {
  return 'https://tnbclive.com';
}
